...
from Bert import WebPageWidget, WebView
from CustomTabWidget import CustomTabWidget



class WebBrowserWindow(QMainWindow):
    def __init__(self, parent=None, init_url: Union[str, QUrl, None] = 'https://bert-81c5d.web.app/'):
    ...
    def addWebPageTab(self, url: Union[str, QUrl] = 'https://bert-81c5d.web.app/'):
